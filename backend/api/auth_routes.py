...
from ..schemas.auth import (EmailRequest, LoginRequest, MessageResponse, PreferencesRequest,
...
GENERIC_MAIL = {"message": "Если адрес подходит для этой операции, письмо поставлено в очередь. Проверьте почту."}
